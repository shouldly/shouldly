...
namespace Shouldly.Tests.InternalTests
{
    ...
    public class DifferenceHighlighterHelpersTests
    {
        ...
        public void HighlightDifferencesBetween_IntegerListsSameExceptOne_HighlightsDifference()
        {
            ...
            DifferenceHighlighterExtensions.HighlightDifferencesBetween(testShouldlyAssertionContext).ShouldBe("[*2*, 2, 3]");
        }
        ...
        public void HighlightDifferencesBetween_ListsSame_DisplaysActualWithoutHighlight()
        {
            ...
            DifferenceHighlighterExtensions.HighlightDifferencesBetween(testShouldlyAssertionContext).ShouldBe("[1, 2, 3]");
        }
        ...
        public void HighlightDifferencesBetween_ListsActualHasLessElements_HighlightsMissingElements()
        {
            ...
            DifferenceHighlighterExtensions.HighlightDifferencesBetween(testShouldlyAssertionContext).ShouldBe("[1, *, *]");
        }
        ...
        public void HighlightDifferencesBetween_DifferentTypes_DisplaysActualWithoutHighlight()
        {
            ...
            DifferenceHighlighterExtensions.HighlightDifferencesBetween(testShouldlyAssertionContext).ShouldBe("[*\"hi\"*, *\"mum\"*]");
        }
        ...
        public void HighlightDifferencesBetween_NotEnumerables_DisplaysActualWithoutHighlight()
        {
            ...
            DifferenceHighlighterExtensions.HighlightDifferencesBetween(testShouldlyAssertionContext).ShouldBe("\"hello\"");
        }
        ...
        public void HighlightDifferencesBetween_ListsSameElementsInDifferentOrder_HighlightAllAsDifferent()
        {
            ...
            DifferenceHighlighterExtensions.HighlightDifferencesBetween(testShouldlyAssertionContext).ShouldBe("[*2*, *3*, *1*]");
        }
        ...
        public void HighlightDifferencesBetween_StringLists_HighlightsDifference()
        {
            ...
            DifferenceHighlighterExtensions.HighlightDifferencesBetween(testShouldlyAssertionContext).ShouldBe("[\"rita\", \"sue\", *\"betty\"*]");
        }
        ...
        public void HighlightDifferencesBetween_EnumLists_HighlightsDifference()
        {
            ...
            DifferenceHighlighterExtensions.HighlightDifferencesBetween(testShouldlyAssertionContext).ShouldBe("[*Weapons.Screwdriver*, Weapons.Axe]");
        }
        ...
        public void HighlightDifferencesBetween_BoolLists_HighlightsDifference()
        {
            ...
            DifferenceHighlighterExtensions.HighlightDifferencesBetween(testShouldlyAssertionContext).ShouldBe("[True, *True*, *False*]");
        }
        ...
        public void HighlightDifferencesBetween_ListOfObjectWithEqualsDefined_HighlightsDifference()
        {
            ...
            DifferenceHighlighterExtensions.HighlightDifferencesBetween(testShouldlyAssertionContext).ShouldBe("[t1, *t3*]");
        }
        ...
        public void HighlightDifferencesBetween_ListOfObjectWithoutEqualsDefined_HighlightsEverythingAsDifference()
        {
            ...
            DifferenceHighlighterExtensions.HighlightDifferencesBetween(testShouldlyAssertionContext).ShouldBe("[*t1*, *t2*]");
        }
        ...
        public void HighlightDifferencesBetween_GenericList_HighlightsDifference()
        {
            ...
            DifferenceHighlighterExtensions.HighlightDifferencesBetween(testShouldlyAssertionContext).ShouldBe("[1, *4*, 3]");
        }
        ...
        public void HighlightDifferencesBetween_ArrayList_HighlightsDifference()
        {
            ...
            DifferenceHighlighterExtensions.HighlightDifferencesBetween(testShouldlyAssertionContext).ShouldBe("[9, *7*, *8*]");
        }
        ...
        public void HighlightDifferencesBetween_PureEnumerable_HighlightsDifference()
        {
            ...
            DifferenceHighlighterExtensions.HighlightDifferencesBetween(testShouldlyAssertionContext).ShouldBe("[9, 8, *6*]");
        }
        ...
        public void HighlightDifferencesBetween_BigList_ShowsLimitedNumberOfElements()
        {
            ...
            var testShouldlyAssertionContext = new TestShouldlyAssertionContext(expectedList, actualList);
            DifferenceHighlighterExtensions.HighlightDifferencesBetween(testShouldlyAssertionContext)
