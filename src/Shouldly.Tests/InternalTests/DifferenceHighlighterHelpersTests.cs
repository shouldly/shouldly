...
public class DifferenceHighlighterHelpersTests
{
    ...
    {
        Should.Throw<ShouldAssertException>(() => new[] { 1, 2, 3 }.ShouldBeSameAs(new[] { 1, 2, 3 }))
