namespace Shouldly
{
    ...
    public static class Should
    {
        ...
        [System.Obsolete(@"Pass a Func<Task> instead of a Task instance, e.g. Should.Throw<T>(DoWorkAsync) or Should.Throw<T>(() => task). A Task argument is evaluated before Shouldly runs, so an exception thrown synchronously (argument validation, for example) escapes the assertion instead of being caught by it.", true)]
    ...
    public static class ShouldBeEnumerableTestExtensions
    {
        ...
        public static void ShouldBeNullOrEmpty<T>(this System.Collections.Generic.IEnumerable<T>? actual, string? customMessage = null, [System.Runtime.CompilerServices.CallerArgumentExpression("actual")] string? actualExpression = null) { }
        ...
        public static void ShouldBeUnique<T>(this System.Collections.Generic.IEnumerable<T> actual, System.Collections.Generic.IEqualityComparer<T> comparer, string? customMessage = null, [System.Runtime.CompilerServices.CallerArgumentExpression("actual")] string? actualExpression = null) { }
    ...
    public static class ShouldBeStringTestExtensions
    {
        ...
        public static void ShouldContain(this string actual, string expected, Shouldly.Case caseSensitivity = 0, string? customMessage = null, [System.Runtime.CompilerServices.CallerArgumentExpression("actual")] string? actualExpression = null) { }
        public static void ShouldContainAll(this string actual, string[] expectedValues, Shouldly.Case caseSensitivity = 0, string? customMessage = null, [System.Runtime.CompilerServices.CallerArgumentExpression("actual")] string? actualExpression = null) { }
        public static void ShouldContainAny(this string actual, string[] expectedValues, Shouldly.Case caseSensitivity = 0, string? customMessage = null, [System.Runtime.CompilerServices.CallerArgumentExpression("actual")] string? actualExpression = null) { }
        ...
        public static void ShouldEndWith([System.Diagnostics.CodeAnalysis.NotNull] this string? actual, string expected, Shouldly.Case caseSensitivity = 0, string? customMessage = null, [System.Runtime.CompilerServices.CallerArgumentExpression("actual")] string? actualExpression = null) { }
        ...
        public static void ShouldNotContain(this string actual, string expected, Shouldly.Case caseSensitivity = 0, string? customMessage = null, [System.Runtime.CompilerServices.CallerArgumentExpression("actual")] string? actualExpression = null) { }
        public static void ShouldNotContainAll(this string actual, string[] expectedValues, Shouldly.Case caseSensitivity = 0, string? customMessage = null, [System.Runtime.CompilerServices.CallerArgumentExpression("actual")] string? actualExpression = null) { }
        public static void ShouldNotContainAny(this string actual, string[] expectedValues, Shouldly.Case caseSensitivity = 0, string? customMessage = null, [System.Runtime.CompilerServices.CallerArgumentExpression("actual")] string? actualExpression = null) { }
        ...
        public static void ShouldNotEndWith(this string? actual, string expected, string? customMessage = null, Shouldly.Case caseSensitivity = 0, [System.Runtime.CompilerServices.CallerArgumentExpression("actual")] string? actualExpression = null) { }
        ...
        public static void ShouldNotStartWith(this string? actual, string expected, Shouldly.Case caseSensitivity = 0, string? customMessage = null, [System.Runtime.CompilerServices.CallerArgumentExpression("actual")] string? actualExpression = null) { }
        public static void ShouldStartWith([System.Diagnostics.CodeAnalysis.NotNull] this string? actual, string expected, Shouldly.Case caseSensitivity = 0, string? customMessage = null, [System.Runtime.CompilerServices.CallerArgumentExpression("actual")] string? actualExpression = null) { }
    }
    [Shouldly.ShouldlyMethods]
    public static class ShouldBeTestExtensions
    {
        ...
        public static void ShouldBe<T>([System.Diagnostics.CodeAnalysis.NotNullIfNotNull("expected")] this System.Collections.Generic.IEnumerable<T>? actual, [System.Diagnostics.CodeAnalysis.NotNullIfNotNull("actual")] System.Collections.Generic.IEnumerable<T>? expected, string? customMessage = null, [System.Runtime.CompilerServices.CallerArgumentExpression("actual")] string? actualExpression = null) { }
