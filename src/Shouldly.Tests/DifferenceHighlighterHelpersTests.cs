...
namespace Shouldly.Tests
{
    ...
    public class DifferenceHighlighterHelpersTests
    {
        ...
        {
            "hello".HighlightDifferencesBetween("goodbye").ShouldBe("\"hello\"");
        }

        [Test]
        public void HighlightDifferencesBetween_ListsSameElementsInDifferentOrder_HighlightAllAsDifferent()
        {
            new[] { 2, 3, 1 }.HighlightDifferencesBetween(new[] { 1, 2, 3 }).ShouldBe("[*2*, *3*, *1*]");
        }

        [Test]
        public void HighlightDifferencesBetween_StringLists_HighlightsDifference()
        {
            new[] { "rita", "sue", "betty" }.HighlightDifferencesBetween(new[] { "rita", "sue", "bob" }).ShouldBe("[\"rita\", \"sue\", *\"betty\"*]");
        }

        [Test]
        public void HighlightDifferencesBetween_EnumLists_HighlightsDifference()
        {
            new[] { Weapons.Screwdriver, Weapons.Axe }.HighlightDifferencesBetween(new[] { Weapons.Chainsaw, Weapons.Axe }).ShouldBe("[*Weapons.Screwdriver*, Weapons.Axe]");
        }

        [Test]
        public void HighlightDifferencesBetween_BoolLists_HighlightsDifference()
        {
            new[] { true, true, false }.HighlightDifferencesBetween(new[] { true, false, true }).ShouldBe("[True, *True*, *False*]");
        }
        ...
        {
            new List<int> { 1, 4, 3 }.HighlightDifferencesBetween(new List<int> { 1, 2, 3 }).ShouldBe("[1, *4*, 3]");
        }

        [Test]
        public void HighlightDifferencesBetween_ArrayList_HighlightsDifference()
        {
            new ArrayList { 9, 7, 8 }.HighlightDifferencesBetween(new ArrayList { 9, 8, 7 }).ShouldBe("[9, *7*, *8*]");
        }

        [Test]
        public void HighlightDifferencesBetween_PureEnumerable_HighlightsDifference()
        {
            new PureEnumerable { 9, 8, 6 }.HighlightDifferencesBetween(new PureEnumerable { 9, 8, 7 }).ShouldBe("[9, 8, *6*]");
        }
        ...
        public void HighlightDifferencesBetween_BigList_ShowsLimitedNumberOfElements()
        {
            ...
            actualList.HighlightDifferencesBetween(expectedList)
