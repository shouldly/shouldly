...
public static class ShouldlyCoreExtensions
{
    ...
    {
        internal bool IsShouldlyMethod()
        {
        ...
        /// </summary>
        internal bool IsSystemDynamicMachinery()
        {
    ...
    extension<T>(T actual)
    {
        ...
        public void AssertAwesomely(Func<T, bool> specifiedConstraint,
        ...
        /// <param name="customMessage">A custom message to display if the assertion fails</param>
        /// <param name="shouldlyMethod">The name of the shouldly method being called</param>
        public void AssertAwesomelyWithCaseSensitivity(Func<T, bool> specifiedConstraint,
            object? originalActual, object? originalExpected,
        ...
        /// <param name="customMessage">A custom message to display if the assertion fails</param>
        /// <param name="shouldlyMethod">The name of the shouldly method being called</param>
        public void AssertAwesomelyIgnoringOrder(Func<T, bool> specifiedConstraint,
            object? originalActual, object? originalExpected,
            string? customMessage = null,
            [CallerMemberName] string shouldlyMethod = null!)
        {
