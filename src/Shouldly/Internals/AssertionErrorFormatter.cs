...
/// shared by <see cref="AssertionScope"/> and ShouldSatisfyAllConditions, so the two stay
/// consistent. Each error is followed by a blank line and the block is terminated with a
/// closing divider; dividers are a fixed width so they align in monospaced output.
/// </summary>
