...
{
    extension<T>(IEnumerable<T> actual)
    {
        /// <summary>
        /// Asserts that the enumerable contains the expected value.
        /// </summary>
        [MethodImpl(MethodImplOptions.NoInlining)]
        public void ShouldContain(T expected, string? customMessage = null)
        {
        ...
        /// </summary>
        [MethodImpl(MethodImplOptions.NoInlining)]
        public void ShouldContain(T expected, IEqualityComparer<T> comparer, string? customMessage = null)
        {
        ...
        /// </summary>
        [MethodImpl(MethodImplOptions.NoInlining)]
        public void ShouldNotContain(T expected, string? customMessage = null)
        {
            if (actual.Contains(expected))
                throw new ShouldAssertException(new ExpectedActualShouldlyMessage(expected, actual, customMessage).ToString());
        }
        ...
        /// </summary>
        [MethodImpl(MethodImplOptions.NoInlining)]
        public void ShouldNotContain(T expected, IEqualityComparer<T> comparer, string? customMessage = null)
        {
            if (actual.Contains(expected, comparer))
                throw new ShouldAssertException(new ExpectedActualShouldlyMessage(expected, actual, customMessage).ToString());
        }
        ...
        /// </summary>
        [MethodImpl(MethodImplOptions.NoInlining)]
        public void ShouldContain([InstantHandle] Expression<Func<T, bool>> elementPredicate, int expectedCount, string? customMessage = null)
        {
        ...
        /// </summary>
        [MethodImpl(MethodImplOptions.NoInlining)]
        public void ShouldContain([InstantHandle] Expression<Func<T, bool>> elementPredicate, string? customMessage = null)
        {
            var condition = elementPredicate.Compile();
        ...
        /// </summary>
        [MethodImpl(MethodImplOptions.NoInlining)]
        public void ShouldNotContain([InstantHandle] Expression<Func<T, bool>> elementPredicate, string? customMessage = null)
        {
            var condition = elementPredicate.Compile();
            if (actual.Any(condition))
                throw new ShouldAssertException(new ExpectedActualShouldlyMessage(elementPredicate.Body, actual, customMessage).ToString());
        ...
        /// </summary>
        [MethodImpl(MethodImplOptions.NoInlining)]
        public void ShouldAllBe([InstantHandle] Expression<Func<T, bool>> elementPredicate, string? customMessage = null)
        {
            var condition = elementPredicate.Compile();
    ...
    extension<T>([NotNull] IEnumerable<T>? actual)
    {
        /// <summary>
        /// Asserts that the enumerable is empty.
        /// </summary>
        [MethodImpl(MethodImplOptions.NoInlining)]
        public void ShouldBeEmpty(string? customMessage = null)
        {
        ...
        /// </summary>
        [MethodImpl(MethodImplOptions.NoInlining)]
        public void ShouldNotBeEmpty(string? customMessage = null)
        {
            if (actual == null || !actual.Any())
                throw new ShouldAssertException(new ExpectedShouldlyMessage(actual, customMessage).ToString());
        }
        ...
        /// </summary>
        [MethodImpl(MethodImplOptions.NoInlining)]
        public T ShouldHaveSingleItem(string? customMessage = null)
        {
    ...
    extension<T>(IEnumerable<T> actual)
    {
        ...
        /// </summary>
        [MethodImpl(MethodImplOptions.NoInlining)]
        public void ShouldBeSubsetOf(IEnumerable<T> expected, string? customMessage = null)
        {
        ...
        /// </summary>
        [MethodImpl(MethodImplOptions.NoInlining)]
        public void ShouldBeSubsetOf(IEnumerable<T> expected, IEqualityComparer<T> comparer, string? customMessage = null)
        {
            if (actual.Equals(expected))
                return;
        ...
        /// </summary>
        [MethodImpl(MethodImplOptions.NoInlining)]
        public void ShouldBeUnique(string? customMessage = null)
        {
        ...
        /// </summary>
        [MethodImpl(MethodImplOptions.NoInlining)]
        public void ShouldBeUnique(IEqualityComparer<T> comparer)
        {
        ...
        /// </summary>
        [MethodImpl(MethodImplOptions.NoInlining)]
        public void ShouldBeUnique(IEqualityComparer<T> comparer, string? customMessage)
        {
    ...
    extension<T>(IEnumerable<T> actual)
    {
        ...
        /// </summary>
        [MethodImpl(MethodImplOptions.NoInlining)]
        public void ShouldBeInOrder(string? customMessage = null)
        {
        ...
        /// </summary>
        [MethodImpl(MethodImplOptions.NoInlining)]
        public void ShouldBeInOrder(SortDirection expectedSortDirection, string? customMessage = null)
        {
        ...
        /// </summary>
        [MethodImpl(MethodImplOptions.NoInlining)]
        public void ShouldBeInOrder(SortDirection expectedSortDirection, IComparer<T>? customComparer, string? customMessage = null)
        {
    ...
    extension<T>(IEnumerable<T> actual)
    {
        ...
        /// </summary>
        [MethodImpl(MethodImplOptions.NoInlining)]
        public void ShouldBeOfTypes(params Type[] expected)
        {
        ...
        /// </summary>
        [MethodImpl(MethodImplOptions.NoInlining)]
        public void ShouldBeOfTypes(Type[] expected, string? customMessage)
        {
