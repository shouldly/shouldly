...
namespace Shouldly
{
    class ObsoleteMessages
    {
        ...
        public const string DiffMessage = """
            Diff tool management is now handled by https://github.com/VerifyTests/DiffEngine. Use the following for custom diff configuration.
